package vn.philong.game.pikachunew.persional;
...
public class PersonalActivity extends FragmentActivity {
	...
	private static final int FRAGMENT_COUNT = USER + 1;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.layout_persional_fragments);
		FragmentManager fm = getSupportFragmentManager();
		fragments[GUEST] = fm.findFragmentById(R.id.guest_fragment);
		fragments[USER] = fm.findFragmentById(R.id.user_fragment);
							...
							try {
								...
								runOnUiThread(new Runnable() {
									...
									public void run() {
										// TODO Auto-generated method stub
										for (int i = 0; i < fragments.length; i++) {
											((FragmentPersonal) fragments[i]).inits();
										}
									}
								});
